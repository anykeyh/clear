...
- [Online Manual – How to start?](https://clear.gitbook.io/project/)
- [The same manual is avaiable offline](https://github.com/anykeyh/clear/blob/master/manual/README.md)
- [Additional references can be found through autogenerated API documentation](https://anykeyh.github.io/clear/)
